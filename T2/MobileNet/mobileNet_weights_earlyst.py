...
output_dir = "resultados_mobilenet_balance_early"
...
# Entrenamiento
print("\nIniciando entrenamiento de MobileNet CON DROPOUT (sin weights, con class_weights y early stopping)...")
...
# Guardar modelo
model_mobilenet.save(f"{output_dir}/mobilenet_balance_early.keras")
with open(f"{output_dir}/history_mobilenet_balance_early.pkl", "wb") as f:
...
plt.title('MobileNet CON BALANCEO DE CLASES - Accuracy')
plt.ylabel('Accuracy')
plt.xlabel('Epocas')
plt.legend()
plt.tight_layout()
...
plt.title('MobileNet CON BALANCEO DE CLASES - Loss')
plt.ylabel('Loss')
plt.xlabel('Epocas')
plt.legend()
plt.tight_layout()
...
plt.xlabel("Predicho")
plt.ylabel("Real")
plt.title("Matriz de Confusion - MobileNet CON BALANCEO DE CLASES")
